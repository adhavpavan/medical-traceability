#!/bin/bash
        ...
        VERSION="1"
        SEQUENCE=1
        CC_SRC_PATH="../artifacts/chaincode1/javascript"
        CC_NAME=producer-distributor-channel-chaincode 

      presetup() {
    echo Installing npm packages ...
    pushd ../artifacts/chaincode1/javascript
    npm install
    popd
...
installChaincode() {
    ...
    commitChaincodeDefination() {
      ...
      peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer1.com \
          ...
          --peerAddresses localhost:7051 --tlsRootCertFiles $manufacturer_CA \
